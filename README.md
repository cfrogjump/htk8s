![test/(https://github.com/cfrogjump/htk8s/workflows/test/badge.svg)
...
```bash
# for x86_64
kubectl apply -f https://raw.githubusercontent.com/cfrogjump/htk8s/v0.2/install_x86_64.yaml

# for raspberry pi (ARM32)
kubectl apply -f https://raw.githubusercontent.com/cfrogjump/htk8s/v0.2/install_armhf.yaml

# for raspberry pi (ARM64)
kubectl apply -f https://raw.githubusercontent.com/cfrogjump/htk8s/v0.2/install_armh64.yaml
```
...
```bash
# x86_64 only
kubectl apply -f https://raw.githubusercontent.com/cfrogjump/htk8s/v0.2/install_argocd.yaml
```
